            ...
            <div className="grid flex-col gap-7">
              <div className="grid gap-1">
                ...
                <Input
                  ...
                  value={email}
                  type="email"
                  placeholder="Enter your mail" className="bg-gray-100" />
              </div>
              <div className="grid gap-1">
                ...
                <a
                  href="#"
                  className="ml-auto inline-block font-ubuntuMono font-bold tracking-widest text-sm underline-offset-4 hover:underline"
                >
